"""Create core MVP database tables

Revision ID: c6bd93b0650c
Revises:
Create Date: 2026-07-25 19:04:58.029239
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["system_id"], ["legacy_systems.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column("archimate_type", sa.String(length=50), nullable=False),
        sa.Column("name", sa.String(length=150), nullable=False),
        sa.Column("git_path", sa.String(length=255), nullable=False),
